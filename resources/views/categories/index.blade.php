...
@section('content')
                        ...
                        <tr class="hover:bg-indigo-50/50 transition-all duration-200 group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-100 to-teal-100 flex items-center justify-center text-emerald-600">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center gap-1 text-sm text-slate-500 bg-slate-50 px-3 py-1 rounded-full border border-slate-200">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <h3 class="text-lg font-semibold text-slate-700 mb-1">No Categories Found</h3>
                                    <p class="text-sm text-slate-500">Create your first category to organize your products</p>
                                    <a href="{{ route('categories.create') }}" 
    ...
    <div class="mt-6 flex items-center justify-between">
        <p class="text-sm text-slate-500">
            Showing <span class="font-semibold text-slate-700">{{ $categories->firstItem() ?? 0 }}</span> 
            to <span class="font-semibold text-slate-700">{{ $categories->lastItem() ?? 0 }}</span> 
            of <span class="font-semibold text-slate-700">{{ $categories->total() }}</span> categories
        </p>
        {{ $categories->links() }}
    </div>
@endsection
