...
<form action="{{ route('brands.store') }}" method="POST" class="bg-white p-6 rounded-3xl shadow-lg">
    @csrf
    ...
    <button type="submit" class="bg-slate-900 hover:bg-slate-800 text-white px-5 py-3 mt-4 rounded-2xl">
        Save Brand
    </button>
</form>
